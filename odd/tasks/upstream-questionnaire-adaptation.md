...
- [ ] **UQA-04a — Preserve partial cancellation results.** User approved splitting UQA-04 to preserve the 400-line cap. Retain committed validated answers on cancellation while omitting drafts/uncommitted state; preserve custom-plus-MULTI values and UQA-03 event behavior. Notes remain UQA-06.
