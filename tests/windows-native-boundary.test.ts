...
test("native-boundary parser accepts only the bounded allowlisted schema", () => {
	...
	assert.deepEqual(parseFixtureLine('{"schema":"gentle-pi.windows-native-boundary/v1","ok":false,"stage":"replace-delete","substage":"rename-collision","codeKind":"win32","code":80,"architecture":"x64","elevated":false}\n'), { schema: "gentle-pi.windows-native-boundary/v1", ok: false, stage: "replace-delete", substage: "rename-collision", codeKind: "win32", code: 80, architecture: "x64", elevated: false });
	assert.deepEqual(parseFixtureLine('{"schema":"gentle-pi.windows-native-boundary/v1","ok":false,"stage":"replace-delete","substage":"replacement-identity","codeKind":"assertion","code":null,"architecture":"x64","elevated":false}\n'), { schema: "gentle-pi.windows-native-boundary/v1", ok: false, stage: "replace-delete", substage: "replacement-identity", codeKind: "assertion", code: null, architecture: "x64", elevated: false });
	for (const line of ["not json\n", '{"schema":"wrong","ok":true,"stage":"abi","architecture":"x64","elevated":false}\n', '{"schema":"gentle-pi.windows-native-boundary/v1","ok":false,"stage":"unknown","architecture":"x64","elevated":false}\n', '{"schema":"gentle-pi.windows-native-boundary/v1","ok":false,"stage":"replace-delete","substage":"unknown","codeKind":"win32","code":80,"architecture":"x64","elevated":false}\n', '{"schema":"gentle-pi.windows-native-boundary/v1","ok":false,"stage":"replace-delete","substage":"rename-collision","codeKind":"unknown","code":80,"architecture":"x64","elevated":false}\n', '{"schema":"gentle-pi.windows-native-boundary/v1","ok":false,"stage":"replace-delete","substage":"rename-collision","codeKind":"win32","code":-1,"architecture":"x64","elevated":false}\n', '{"schema":"gentle-pi.windows-native-boundary/v1","ok":false,"stage":"replace-delete","substage":"rename-collision","codeKind":"win32","code":1.5,"architecture":"x64","elevated":false}\n', '{"schema":"gentle-pi.windows-native-boundary/v1","ok":false,"stage":"replace-delete","substage":"rename-collision","codeKind":"win32","code":"80","architecture":"x64","elevated":false}\n', '{"schema":"gentle-pi.windows-native-boundary/v1","ok":false,"stage":"replace-delete","substage":"rename-collision","codeKind":"win32","code":NaN,"architecture":"x64","elevated":false}\n', '{"schema":"gentle-pi.windows-native-boundary/v1","ok":false,"stage":"replace-delete","substage":"rename-collision","codeKind":"win32","code":4294967296,"architecture":"x64","elevated":false}\n', '{"schema":"gentle-pi.windows-native-boundary/v1","ok":false,"stage":"replace-delete","substage":"rename-collision","codeKind":"win32","code":null,"architecture":"x64","elevated":false}\n', '{"schema":"gentle-pi.windows-native-boundary/v1","ok":false,"stage":"replace-delete","substage":"replacement-identity","codeKind":"assertion","code":null,"architecture":"x64","elevated":false,"detail":"S-1-5-21-untrusted"}\n', '{"schema":"gentle-pi.windows-native-boundary/v1","ok":true,"architecture":"x64","elevated":false,"stages":["abi","anchored-open","dacl","identity","replace-delete","reparse-negative"],"scope":"private-disposable-root","substage":"rename-collision"}\n', '{"schema":"gentle-pi.windows-native-boundary/v1","ok":true,"architecture":"x64","elevated":false,"stages":[],"scope":"private-disposable-root","sid":"secret"}\n', "x".repeat(16_385)]) assert.throws(() => parseFixtureLine(line));
});
...
test("native-boundary runner exposes only allowlisted diagnostic fields for a nonzero native failure", async () => {
	const rawDetail = "S-1-5-21-untrusted";
	const failed = JSON.stringify({ schema: "gentle-pi.windows-native-boundary/v1", ok: false, stage: "replace-delete", substage: "rename-collision", codeKind: "win32", code: 80, architecture: "x64", elevated: false });
	...
	await assert.rejects(fixture.operation, (error: Error) => {
		assert.equal(error.message, "native-boundary host failed (category: nonzero-exit) (stage: replace-delete) (substage: rename-collision) (code-kind: win32) (code: 80)");
